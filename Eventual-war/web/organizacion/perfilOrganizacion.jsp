...
<html>
    <%
        PerfilOrganizacion perfilOrg = (PerfilOrganizacion) request.getAttribute("datosOrg");
    ...
    <head>
        ...
        <title>Eventual | <% out.print(perfilOrg.getNombreOrg()); %></title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">              
                <div class="box-body box-profile">
                  ...
                  <h3 class="profile-username text-center"> Nombre Organizacion : <% out.print(perfilOrg.getNombreOrg().split(" ", 2)[0]); %>
                    <small></small> </h3>
