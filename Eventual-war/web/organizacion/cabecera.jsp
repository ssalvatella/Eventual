...
<span style="display: none" id="ID_USUARIO"><% out.write(perfil.getId() + ""); %></span>
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="./Organizacion" class="logo">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="./assets/img/bar1.jpg" class="user-image" alt="<% out.print(perfil.getNombre()); %>">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <% out.print(perfil.getNombre()); %> - <% out.print((perfil.getCategoria() != null) ? perfil.getCategoria() : ""); %>
